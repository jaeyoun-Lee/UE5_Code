...
#include "GBKhaimera.generated.h"

UCLASS()
class GBGAME_API AGBKhaimera : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	void DeadEnemy();		// Enemy(= Khaimera)가 죽었을때 실행되는 함수
...
private:
	...
	UPROPERTY()
	class UKhaimeraAnimInstance* khaimeraAnim;
